...
- **Changements de régime** calme ⇄ volatil : le multiplicateur de volatilité (×0,5 à ×3,1)
  transite progressivement, avec des durées de régime tirées au hasard.
...
| Carnet d'ordres | Flux temps réel, 11 niveaux par côté, barres de profondeur, cumul, spread en points de base, prix microstructurel, jauge de déséquilibre |
| Temps & ventes | Bande défilante colorée achat / vente, mise en évidence des blocs, marquage de vos propres exécutions (`◄`) |
| Liste de suivi | 6 instruments, prix, variation, sparklines animées, clignotement vert/rouge sur tick, clic pour changer d'instrument |
